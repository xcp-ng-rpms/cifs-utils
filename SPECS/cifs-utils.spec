...
# XCP-ng backport to el7
Patch1000: 0001-Fix-build-with-pre-c99-compilers.patch
...
%changelog
* Wed Mar 19 2025 Yann Dirson <yann.dirson@vates.tech> - 7.1-2.0.ydi1
- Build for XCP-ng 8.3
- Removed "Recommends: cifs-utils-info" as not supported by el7 rpm
- Changed BuildRequires to pull python36-docutils
- Add build fix for older toolchain: 0001-Fix-build-with-pre-c99-compilers.patch
